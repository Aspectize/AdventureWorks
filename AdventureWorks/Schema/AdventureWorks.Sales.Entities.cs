...
namespace AdventureWorks.Sales
{
	...
	public class SalesPerson : Entity, IDataWrapper
	{
		public static partial class Fields
		{
			...
			public const string GraphEnd = "GraphEnd";
		...
		[Data(MustPersist = false, IsNullable = true, Expression = "Browser/ClientGraphService.GetGraphEnd(MaxSales);")]
		public int? GraphEnd
		{
			get { return getValue<int?>("GraphEnd"); }
			set { setValue<int?>("GraphEnd", value); }
		}

		[Data(MustPersist = false, IsNullable = true, Expression = "Browser/ClientGraphService.GetGraphStep(MaxSales);")]
		public int? GraphStep
		{
			get { return getValue<int?>("GraphStep"); }
			set { setValue<int?>("GraphStep", value); }
		}
	...
	[DataDefinition(PhysicalSchema = "Sales")]
	public class SalesTerritoryHistory : DataWrapper, IDataWrapper, IRelation
	{
		public static partial class Fields
		{
			public const string StartDate = "StartDate";
		...
		[RelationEnd(Type = typeof(SalesPerson), Role = typeof(SalesPerson), Multiplicity = Multiplicity.ZeroOrMany, FkNames = "SalesPersonID")]
		public IEntity SalesPerson;

		[RelationEnd(Type = typeof(SalesTerritory), Role = typeof(SalesTerritory), Multiplicity = Multiplicity.ZeroOrMany, FkNames = "TerritoryID")]
		public IEntity SalesTerritory;
